...
const ActualMap = () => {
    ...
    const handleSearch = () => {
        const placeId = mapInfo.idtosearch
    ...
    useEffect(()=>{mapInfo.idtosearch?handleSearch():console.log("Map.js handleSearch Effect fired but id is null");},[mapInfo.idtosearch])
